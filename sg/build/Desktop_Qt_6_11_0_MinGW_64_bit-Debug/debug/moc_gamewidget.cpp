...
void GameWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->onMoodImageClicked((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->onSaveClicked(); break;
        case 2: _t->onMonthChanged((*reinterpret_cast<std::add_pointer_t<int>>(_a[1]))); break;
        case 3: _t->onAddClicked(); break;
        case 4: _t->onCancelClicked(); break;
        case 5: _t->hideTip(); break;
        default: ;
        }
    }
}
